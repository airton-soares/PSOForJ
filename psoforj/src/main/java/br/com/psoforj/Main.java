...
public class Main {
	 ...
	 * @param args
	 *            [5] - Coeficiente de inércia inicial
	 * @param args
	 *            [6] - Coeficiente de inércia final
	 * @param args
	 *            [7] - Limite inferior de inicialização
	 * @param args
	 *            [8] - Limite superior de inicialização
	 */
	public static void main(String[] args) {
		...
		PSO pso = new PSO(new SphereFunction(bottomDomainLimit, topDomainLimit), populationSize, dimension,
				bottomDomainLimit, topDomainLimit, TopologyType.FOCAL);
		double[] populationBestFitnessHistory = pso.optimize(initialInertiaCoefficient, finalInertiaCoefficient, cognitiveCoefficient,
				socialCoefficient, numberOfIteractions);
