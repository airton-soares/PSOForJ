...
public class Population {
	...
	public Population(int numberOfParticles, int dimension, double bottomDomainLimit, double topDomainLimit, TopologyType topologyType) {
		this.subPopulationList = initializePopulation(numberOfParticles, dimension, bottomDomainLimit, topDomainLimit, topologyType);
	}
	
	private List<SubPopulation> initializePopulation(int numberOfParticles, int dimension, double bottomDomainLimit, double topDomainLimit, TopologyType topologyType){
